...
public class MainFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        RadioGroup group = (RadioGroup) view.findViewById(R.id.turtle_group);
        ...
        ImageButton img = (ImageButton) view.findViewById(R.id.turtle);
    ...
    public void showDetailsAboutTurtle() {
        ...
        //in this case the seconds fragment, DetailsFragment should be there
